...
[$x] = UtilIO::getIntArray();
$a = UtilIO::getIntArray();
$b = UtilIO::getIntArray();
$ans = (in_array($x, $a, true) ? "Mr":"")."Max".(in_array($x, $b, true) ? "Valu":"");
UtilIO::echo($ans==="Max"?"-1":$ans);


function isHoliday(string $s) {
    return $s === "Sat" || $s === "Sun";
}
